...
iFileStart=1;
iFileEnd=81;
sPath='/Users/YA1/Documents/MATLAB/MAE 6230/Combustion Solver/Outputs_Re_100/';
sPrefix='T_Re_100Iter_';

h=figure()
Vx=linspace(0,15*H,nx);
...
drawnow
gif('CombustionSimulationRe100.gif','DelayTime',0.1,'LoopCount',5,'frame',gcf)
